...
export const CLINICAL_SUPPLIES_CAROUSEL_IMAGES = [
  '/images/clinical-supplies/products/face-masks.png',
  '/images/clinical-supplies/products/surgical-gloves.png',
  '/images/clinical-supplies/products/gauze-bandages.png',
  '/images/clinical-supplies/products/syringes.png',
];
